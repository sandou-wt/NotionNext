...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Sandou', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '挥着紫色蜡笔前行', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://sandou.site', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, sandou, 忒修斯之船', // 网站关键词 英文逗号隔开
  ...
  PRISM_THEME_PREFIX_PATH:
    ...
    'https://cdn.jsdelivr.net/npm/prismjs@1.29.0/themes/prism-tomorrow.css', // 代码块默认主题 test
  ...
  PRISM_THEME_DARK_PATH:
    ...
    'https://cdn.jsdelivr.net/npm/prismjs@1.29.0/themes/prism-tomorrow.css', // 深色模式主题
